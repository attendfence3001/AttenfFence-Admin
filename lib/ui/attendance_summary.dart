...
import 'package:attedence_admin_panel/models/attendece.dart';
...
final Map<DateTime, List> _holidays = {
  ...
  DateTime(2024, 11, 18): ['Easter Monday'],
  DateTime(2024, 12, 25): ['Christmas Eve'],
};

class AttendanceSummary extends StatefulWidget {
  AttendanceSummary({Key? key, required this.title}) : super(key: key);
...
class _AttendanceSummaryState extends State<AttendanceSummary>
  ...
  void _onDaySelected(DateTime day, List events) {
    ...
    AttendanceDatabase()
        .getAttendanceListOfParticularDateBasedOnUID(
            UserPreferences.getUserId(), day)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Container(
          color: Color.fromRGBO(105, 106, 183, 1),
          child: Column(
